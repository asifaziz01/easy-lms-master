...
$(document).ready (function () {
	tinymce.init({
		...
		toolbar: "insertfile undo redo | styleselect formatselect fontselect fontsizeselect | bold italic underline | alignleft aligncenter alignright alignjustify | bullist numlist outdent indent | link image media | table | preview fullpage | code charmap",
