	...
	<?php echo form_open ('coaching/lesson_actions/create_lesson/'.$coaching_id.'/'.$course_id.'/'.$lesson_id, array('class' => 'card', 'id' => 'validate-1')); ?> 
		<div class="card-body">
			...
			<div class="form-group">
				...
				<textarea class="form-control tinyeditors" name="description" rows="10" placeholder="How you describe this lesson?"><?php echo set_value ('description', $lesson['description']); ?></textarea>
			</div>
